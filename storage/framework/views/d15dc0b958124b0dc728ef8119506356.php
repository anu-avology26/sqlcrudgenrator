...
<div class="container">
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('sql-crud-generator.generate')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="grid">
                <div class="field">
                    <label>Module Name</label>
                    <input class="input" type="text" name="module_name" value="<?php echo e(old('module_name', $moduleName ?? '')); ?>" placeholder="Blog">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <select name="generation_mode">
                        <option value="auto" <?php echo e($selectedGenerationMode === 'auto' ? 'selected' : ''); ?>>Auto (Prefer SQL, fallback Prompt)</option>
                        <option value="sql" <?php echo e($selectedGenerationMode === 'sql' ? 'selected' : ''); ?>>SQL Only</option>
                        <option value="prompt" <?php echo e($selectedGenerationMode === 'prompt' ? 'selected' : ''); ?>>Prompt Only</option>
                    </select>
                    <?php $__errorArgs = ['generation_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="error"><?php echo e($message); ?></div> <?php unset($message);
            ...
            <div class="grid">
                <div class="field">
                    ...
                    <select name="crud_mode">
                        ...
                        <option value="web" <?php echo e($selectedMode === 'web' ? 'selected' : ''); ?>>Web</option>
                        <option value="api" <?php echo e($selectedMode === 'api' ? 'selected' : ''); ?>>API</option>
                        <option value="both" <?php echo e($selectedMode === 'both' ? 'selected' : ''); ?>>Both</option>
                    </select>
                    <?php $__errorArgs = ['crud_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="error"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field">
                ...
                <textarea name="sql_schema" placeholder="Paste CREATE TABLE statements..."><?php echo e(old('sql_schema', $sqlSchema ?? '')); ?></textarea>
                <?php $__errorArgs = ['sql_schema'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="error"><?php echo e($message); ?></div> <?php unset($message);
...
Field: total_amount (decimal(10,2))"><?php echo e(old('prompt_spec', $promptSpec ?? '')); ?></textarea>
                <?php $__errorArgs = ['prompt_spec'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="error"><?php echo e($message); ?></div> <?php unset($message);
            ...
            <div class="grid">
                <div class="field">
                    ...
                    <select name="template_mode">
                        <option value="default" <?php echo e($selectedTemplate === 'default' ? 'selected' : ''); ?>>Default Theme</option>
                        <option value="custom_code" <?php echo e($selectedTemplate === 'custom_code' ? 'selected' : ''); ?>>Paste Custom Layout Code</option>
                        <option value="uploaded_file" <?php echo e($selectedTemplate === 'uploaded_file' ? 'selected' : ''); ?>>Upload Template File</option>
                    </select>
                    <?php $__errorArgs = ['template_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="error"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <input class="input" type="email" name="notification_email" value="<?php echo e(old('notification_email', $notificationEmail ?? '')); ?>" placeholder="dev@example.com">
...
unset($__errorArgs, $__bag); ?>
            ...
            <textarea name="template_code" placeholder="Paste full HTML layout. Use {{content}} where CRUD content should render."><?php echo e(old('template_code', $templateCode ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <?php $__errorArgs = ['template_screenshot'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="error"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="toggle-grid">
                <label class="toggle"><input type="checkbox" name="overwrite_existing" value="1" <?php echo e(old('overwrite_existing', $defaultOverwrite ?? false) ? 'checked' : ''); ?>> Overwrite existing module files</label>
                <label class="toggle"><input type="checkbox" name="enable_ajax" value="1" <?php echo e(old('enable_ajax', $enableAjax ?? false) ? 'checked' : ''); ?>> AJAX-ready web CRUD</label>
                <label class="toggle"><input type="checkbox" name="enable_import_export" value="1" <?php echo e(old('enable_import_export', $enableImportExport ?? false) ? 'checked' : ''); ?>> Import/Export (CSV)</label>
                <label class="toggle"><input type="checkbox" name="enable_email_notifications" value="1" <?php echo e(old('enable_email_notifications', $enableEmailNotifications ?? false) ? 'checked' : ''); ?>> Email notifications on create/update</label>
                <label class="toggle"><input type="checkbox" name="generate_migrations" value="1" <?php echo e(old('generate_migrations', $generateMigrations ?? true) ? 'checked' : ''); ?>> Generate Migrations</label>
                <label class="toggle"><input type="checkbox" name="auto_run_migrations" value="1" <?php echo e(old('auto_run_migrations', $autoRunMigrations ?? false) ? 'checked' : ''); ?>> Auto Run Migrations</label>
            </div>
        ...
        <?php if(isset($writeReport)): ?>
            <div class="ok">
                Controllers path: <strong><?php echo e($context['controllers_path'] ?? ''); ?></strong><br>
                Models path: <strong><?php echo e($context['models_path'] ?? ''); ?></strong><br>
                Requests path: <strong><?php echo e($context['requests_path'] ?? ''); ?></strong><br>
                Views path: <strong><?php echo e($context['views_path'] ?? ''); ?></strong><br>
                Created: <?php echo e(count($writeReport['created'] ?? [])); ?>,
                Updated: <?php echo e(count($writeReport['updated'] ?? [])); ?>,
                Skipped: <?php echo e(count($writeReport['skipped'] ?? [])); ?>,
                Errors: <?php echo e(count($writeReport['errors'] ?? [])); ?>

                <?php if(!empty($writeReport['migrations_ran'])): ?>
        ...
        <div class="card">
            ...
            <div class="report-grid">
                <div class="report-box">
                    <h3>Created</h3>
                    <?php if(empty($writeReport['created'])): ?> <p>No files created.</p> <?php else: ?>
                        <ul class="list"><?php $__currentLoopData = $writeReport['created']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($file); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
                    <?php endif; ?>
                </div>
                <div class="report-box">
                    <h3>Updated</h3>
                    <?php if(empty($writeReport['updated'])): ?> <p>No files updated.</p> <?php else: ?>
                        <ul class="list"><?php $__currentLoopData = $writeReport['updated']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($file); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
                    <?php endif; ?>
                </div>
                <div class="report-box">
                    <h3>Skipped</h3>
                    <?php if(empty($writeReport['skipped'])): ?> <p>No files skipped.</p> <?php else: ?>
                        <ul class="list"><?php $__currentLoopData = $writeReport['skipped']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($file); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
                    <?php endif; ?>
                </div>
                <div class="report-box">
                    <h3>Errors</h3>
                    <?php if(empty($writeReport['errors'])): ?> <p>No errors.</p> <?php else: ?>
                        <ul class="list"><?php $__currentLoopData = $writeReport['errors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($error); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="report-box" style="margin-top: 14px;">
                ...
                <p>Added: <?php echo e($writeReport['provider_added'] ?? 'No'); ?></p>
                <p>Skipped: <?php echo e($writeReport['provider_skipped'] ?? 'No'); ?></p>
            </div>

            <?php if(!empty($writeReport['migration_output'])): ?>
                <h3 style="margin-top:14px;">Migration Output</h3>
                <pre><?php echo e($writeReport['migration_output']); ?></pre>
            <?php endif; ?>
        </div>

        <div class="card">
            <h2 class="section-title">Parsed Schema</h2>
            <pre><?php echo e(json_encode($output['parsed_schema'] ?? [], JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES)); ?></pre>
        </div>
    <?php endif; ?>
</div>
<script>
...
<?php /**PATH D:\xampp\htdocs\sql2laravel\packages\SqlCrudGenerator\src/../resources/views/index.blade.php ENDPATH**/ ?>